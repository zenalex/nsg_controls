            ...
            wrapNotDisabled(
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Expanded(child: widget.widgetTop),
                    if (!widget.isDisabled)
                      (_expanded ? widget.iconWidgetUp : widget.iconWidgetDown) ??
                          Icon(
                            _expanded == true ? Icons.arrow_drop_up : Icons.arrow_drop_down,
                            color: _expanded == true
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const Padding(
                                      ...
                                      child: Text('Свернуть', textAlign: TextAlign.center),
                                    ),
                                  ],
                                ),
                              ),
              ...
              if (absY > Get.height - 200) {
                Future.delayed(const Duration(milliseconds: 500), () async {
                  ...
                  widget.scrollController!.animateTo(
                    widget.scrollController!.offset + h - diff + 43,
