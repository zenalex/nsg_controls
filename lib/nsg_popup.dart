    ...
    return Material(
        ...
        child: BackdropFilter(
          ...
          child: widget.dataController == null
              ? _widgetData()
              : widget.dataController!.obx((state) => _widgetData()),
        ));
  }
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color:
                          ControlOptions.instance.colorText.withOpacity(0.05),
                    ),
                    child: Row(
                      children: [
                        IconButton(
                  ...
                  if (widget.contentSecondary != null)
                    Expanded(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: ControlOptions.instance.colorMainOpacity),
                        child: Column(
                          children: [
                            Padding(
                            ...
                            Expanded(
                              child: Scrollbar(
                                ...
                                child: SingleChildScrollView(
                                    controller: controller2,
                                    child: Wrap(
                                        children: widget.contentSecondary!)),
                              ),
                            ),
                          ],
                        ),
